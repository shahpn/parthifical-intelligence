...
input1 = "Can you tell me about IST 402"
output1 = classify_input(input1)
input2 = "When was the Woodland Building built?"
output2 = classify_input(input2)
input3 = "Where is the Event today?"
output3 = classify_input(input3)
input4 = "What is Professor Steven's office hours?"
output4 = classify_input(input4)

divider()
print(f"Input: {input1}\nTopic: {output1}") # Courses
divider()
print(f"Input: {input2}\nTopic: {output2}") # History
divider()
print(f"Input: {input3}\nTopic: {output3}") # Location
divider()
print(f"Input: {input4}\nTopic: {output4}") # Advising
divider()
